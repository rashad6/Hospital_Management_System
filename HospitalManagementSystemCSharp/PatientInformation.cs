...
namespace HospitalManagementSystemCSharp
{
    public partial class PatientInformation : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Rashad\source\repos\HospitalManagementSystemCSharp\hospital.mdf;Integrated Security=True");
            ...
            if (textBox1.Text != "")
            {
                try
                {
                    string getCust = "select name,gen,age,date,cont,addr,disease,status,r_type,building,r_no,price from xeste where id=" + Convert.ToInt32(textBox1.Text) + " ;";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = " Update xeste set name='" + textBox2.Text + "',gen='" + gen + "',age='" + textBox3.Text + "',date='" + textBox4.Text + "',cont='" + textBox5.Text + "',addr='" + textBox6.Text + "',disease='" + textBox7.Text + "',status='" + textBox8.Text  + "',r_type='" + textBox10.Text + "',building='" + textBox9.Text + "',r_no='" + textBox11.Text + "',price='" + textBox12.Text + "' where id='" + textBox1.Text + "'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string str = "DELETE FROM xeste WHERE id = '" + textBox1.Text + "'";
